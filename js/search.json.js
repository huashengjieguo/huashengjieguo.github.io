(function() {
    var keyInput = document.getElementById('search-key'),
        ...
        searchTpl = document.getElementById('search-tpl'),
        winWidth, winHeight, searchData;
    
    // 如果搜索元素不存在，直接退出
    if (!keyInput || !searchWrap || !searchMask || !searchResult || !searchTpl) {
        return;
    }
    
    var searchTplContent = searchTpl.innerHTML;
